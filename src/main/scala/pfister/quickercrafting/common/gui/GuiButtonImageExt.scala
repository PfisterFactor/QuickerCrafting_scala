...
// I don't know why its not there in the first place
class GuiButtonImageExt(id: Int, x: Int, y: Int, width: Int, height: Int, xtext: Int, ytext: Int, ydiff: Int, res: ResourceLocation) extends GuiButtonImage(id, x, y, width, height, xtext, ytext, ydiff, res) {
